 ...
 * 
 * http://localhost:8484/api/pay/success http://localhost:8484/api/pay/fail
 ...
 * 'https://open-api.kakaopay.com/online/v1/payment/ready' \ --header
 * 'Authorization: SECRET_KEY ${SECRET_KEY}' \ --header 'Content-Type:
 * application/json' \ --data '{ "cid": "TC0ONETIME", "partner_order_id":
 * "partner_order_id", "partner_user_id": "partner_order_id", "item_name":
 * "초코파이", "quantity": "1", "total_amount": "2200", "vat_amount": "200",
 * "tax_free_amount": "0", "approval_url":
 * "https://developers.kakao.com/success", "fail_url":
 * "https://developers.kakao.com/fail", "cancel_url":
 * "https://developers.kakao.com/cancel" }'
 * 
 * > response Response: 정상적으로 요청에 성공한 경우 HTTP/1.1 200 OK Content-type:
 * application/json;charset=UTF-8 { "tid": "T1234567890123456789",
 * "next_redirect_app_url":
 * "https://mockup-pg-web.kakao.com/v1/xxxxxxxxxx/aInfo",
 * "next_redirect_mobile_url":
 * "https://mockup-pg-web.kakao.com/v1/xxxxxxxxxx/mInfo",
 * "next_redirect_pc_url": "https://mockup-pg-web.kakao.com/v1/xxxxxxxxxx/info",
 * "created_at": "2023-07-15T21:18:22" }
 * 
 * 
 * +++++++++++++++++ 결제승인 Request curl --location
 * 'https://open-api.kakaopay.com/online/v1/payment/approve' \ --header
 * 'Authorization: SECRET_KEY ${SECRET_KEY}' \ --header 'Content-Type:
 * application/json' \ --data '{ "cid": "TC0ONETIME", "tid":
 * "T1234567890123456789", "partner_order_id": "partner_order_id",
 * "partner_user_id": "partner_user_id", "pg_token": "xxxxxxxxxxxxxxxxxxxx" }'
 * Response: 결제 수단 MONEY일 때 성공 HTTP/1.1 200 OK Content-type:
 * application/json;charset=UTF-8 { "aid": "A5678901234567890123", "tid":
 * "T1234567890123456789", "cid": "TC0ONETIME", "partner_order_id":
 * "partner_order_id", "partner_user_id": "partner_user_id",
 * "payment_method_type": "MONEY", "item_name": "초코파이", "quantity": 1, "amount":
 * { "total": 2200, "tax_free": 0, "vat": 200, "point": 0, "discount": 0,
 * "green_deposit": 0 }, "created_at": "2023-07-15T21:18:22", "approved_at":
 * "2023-07-15T21:18:22" }
 * 
 */