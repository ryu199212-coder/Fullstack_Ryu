...
목적 : 사용자 계좌관리 기느을 제공하는 콘솔기반 은행 시스템
...
Back_Main → UserInfo       <연관관계> 실선화살표 - 멤버변수로 포함
Back_Main → BankController <의존관계> 점선화살표 - 인터페이스를 일시적으로 사용 
                                                ex)Login, Add 교체해서 사용

참고1)
※ 연관관계 : 어떤혁할 수행(long)      - 실선 화살표
※ 의존관계 :            (short)     - 점선 화살표
※ 실체화 관계 : 인터페이스와 구현클래스 - 속이 빈 화살표 점선 - can do this

※ 일반화 관계 : 상속                 - 속이 빈 화살표 실선 - is a 
※ 집합관계 : 합성관계 - 생성자에서 new - ◆
             합성관계 - 생성자에서 new - ◇
...
class Driver{
 ...
 asdfgsgfdgsdfgsdfgsdfgsdfgsfgsfgs



 second second 2222222222